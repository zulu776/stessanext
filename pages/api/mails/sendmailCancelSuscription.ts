...
const sendmailCancelSuscription = async (req, res) => {
  if (req.method === 'POST') {
    const { email = 'gerencia@baselegal.co' } = req.body;
    ...
    const message = {
      ...
      to: email,
      subject: `Cancelación de suscripción - BASE LEGAL`,
      html: `
                              ...
                              >
                                <tr style="border-collapse:collapse">
                                  <td align="center" style="padding:0;Margin:0">
                                    ...
                                    >
                                      <strong
                                        >Has cancelado tu suscripción</strong
                                      >
                                    </h2>
                                  </td>
                                </tr>
                            ...
                            >
                              ...
                              >
                                <tr style="border-collapse:collapse">
                                  <td
                                    align="center"
                                    style="Margin:0;padding-bottom:30px;padding-top:35px;padding-left:40px;padding-right:40px"
                                  >
                                    <p
                                    ...
                                    >
                                      <span style="font-size:15px">
                                        Ahora no formas parte de nuestro Plan
                                        Premium, esto significa que pasaste a
                                        ser usuario free de Base Legal y que
                                        deberás adquirir tus documentos de forma
                                        individual, pero recuerda que siempre
                                        puedes volver a unirte y disfrutar de
                                ...
                                <tr style="border-collapse:collapse">
                                  <td
                                    align="center"
                                    style="Margin:0;padding-bottom:30px;padding-top:35px;padding-left:40px;padding-right:40px;border-style: none;"
                                  >
                                    <a
                                      href="https://baselegal.vercel.app/planes-y-precios"
                                    >
                                      <button
                                        style="background-color: #f2a111;border-style: none; border-radius: 10px;"
                                      >
                                        <p
                                          style="color: white;font-weight: 800;font-size: large;padding-left: 20px;padding-right: 20px;"
                                        >
...
export default sendmailCancelSuscription;
